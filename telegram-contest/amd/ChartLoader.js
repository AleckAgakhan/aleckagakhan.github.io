define(["require", "exports", "./ChartModel.js", "./ChartContext.js", "./TemplateProvider.js", "./common.js", "./ChartTheme.js"], function (require, exports, ChartModel_js_1, ChartContext_js_1, TemplateProvider_js_1, common_js_1, ChartTheme_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.TagName = exports.ChartLoaderElement = void 0;
    const createChartModel = (data) => {
        ...
        for (const key in colors) {
            ...
            chartLine.color = new common_js_1.Color(colors[key]);
        }
        ...
        return new ChartModel_js_1.ChartModel(xKey, xColumn, lineMap, lineOrder);
    };
    class ChartLoaderElement extends TemplateProvider_js_1.TemplateProviderElement {
        connectedCallback() {
        ...
        async loadData(url, chartTemplateKey) {
            ...
            for (const data of dataList) {
                ...
                const contextElement = chartElement.querySelector(ChartContext_js_1.TagName);
                if (!contextElement)
                    throw new Error(`Unable to find the element <${ChartContext_js_1.TagName}> in the template '${chartTemplateKey}'.`);
