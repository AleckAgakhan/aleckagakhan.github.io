define(["require", "exports", "./ChartModel.js", "./ChartTheme.js", "./common.js", "./ChartContextTemplateConsumer.js"], function (require, exports, ChartModel_js_1, ChartTheme_js_1, common_js_1, ChartContextTemplateConsumer_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.TagName = exports.CanvasChartViewElement = void 0;
    ...
    class CanvasChartView {
        constructor(element, model, pointTooltip, pointTooltipContainer, dateContainer, templateProvider, pointInfoTemplateKey) {
            ...
            this.theme = (0, ChartTheme_js_1.getCurrentTheme)();
        ...
        [ChartModel_js_1.chartModelChangeHandlerKey](model, timestamp) {
            ...
            for (const line of model.orderedLines) {
                ...
                switch ((0, ChartModel_js_1.getChartLineVState)(line)) {
                    case 2:
                        {
                            if (lineInfo) {
                                lineInfo.line = line;
            ...
            if (currRangeLength > 0.5) {
                ...
                while (true) {
                    ...
                    const text = (0, common_js_1.getMonthDayString)(date);
        ...
        renderAnimationFrame(timestamp) {
            ...
            if (animationState.lineInfoMap.size === 0)
                return;
            const color = new common_js_1.Color();
            ...
            if (isMaxAnimation && progressRatio < 1) {
                const labelColor = new common_js_1.Color(themeLabelColor);
            ...
            for (const line of model.orderedLines) {
                ...
                if (xGridLine !== undefined) {
                    ...
                    if (index >= 0) {
                        ...
                        context.arc(xGridLineInt, cy, viewTheme.pointRadius, 0, common_js_1.PIx2);
                        context.fill();
                        context.stroke();
                    }
                }
        ...
        showPointToolTip(x, y, index) {
            ...
            this.dateContainer.textContent = (0, common_js_1.getMonthDayString)(model.xColumn[index + 1]);
        ...
        updatePointToolTip() {
            ...
            for (const line of this._model.currVisibleLines) {
                ...
                if (!pointInfoElement) {
                    ...
                    if (!lineNameElement)
                        throw new Error((0, common_js_1.missingTemplateElementMsg)(exports.TagName, this.pointInfoTemplateKey, "LineName"));
                    ...
                    if (!pointValueElement)
                        throw new Error((0, common_js_1.missingTemplateElementMsg)(exports.TagName, this.pointInfoTemplateKey, "PointValue"));
    ...
    class CanvasChartViewElement extends ChartContextTemplateConsumer_js_1.ChartContextTemplateConsumerElement {
        createController(model) {
            ...
            if (!dateContainer)
                throw new Error((0, common_js_1.missingElementInsideTemplateMsg)(exports.TagName, pointTooltipTemplatekey, "DateContainer"));
            const pointTooltipContainer = pointTooltipFragment.getElementById("PointTooltipContainer");
            if (!pointTooltipContainer)
                throw new Error((0, common_js_1.missingElementInsideTemplateMsg)(exports.TagName, pointTooltipTemplatekey, "PointTooltipContainer"));
        ...
        connectedCallback() {
            ...
            (0, ChartTheme_js_1.addShadowRootContainer)(this);
        }
        disconnectedCallback() {
            (0, ChartTheme_js_1.removeShadowRootContainer)(this);
        }
    }
