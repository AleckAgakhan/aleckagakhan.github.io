define(["require", "exports", "./ChartModel.js", "./ChartContextTemplateConsumer.js", "./common.js"], function (require, exports, ChartModel_js_1, ChartContextTemplateConsumer_js_1, common_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.InputChartRangeSelectorElement = exports.TagName = void 0;
    ...
    class InputChartRangeSelectorElement extends ChartContextTemplateConsumer_js_1.ChartContextTemplateConsumerElement {
        createController(model) {
            ...
            if (!rangeStartInput)
                throw new Error((0, common_js_1.missingElementInsideTemplateMsg)(exports.TagName, contentKey, "RangeStart"));
            ...
            if (!rangeEndInput)
                throw new Error((0, common_js_1.missingElementInsideTemplateMsg)(exports.TagName, contentKey, "RangeEnd"));
            ...
            if (!applyButton)
                throw new Error((0, common_js_1.missingElementInsideTemplateMsg)(exports.TagName, contentKey, "RangeApply"));
            const itemContainer = contentFragment.getElementById("RangeItemContainer");
            if (!itemContainer)
                throw new Error((0, common_js_1.missingElementInsideTemplateMsg)(exports.TagName, contentKey, "RangeItemContainer"));
