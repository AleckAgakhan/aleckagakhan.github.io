export const getChartLineVState = (line) => line.isCurrVisible
...
export const chartModelChangeHandlerKey = Symbol('ChartModel::ChangeHandler');
export class ChartModel {
    ...
    animationCallback(timestamp) {
        ...
        for (const subscriber of this.subscribers) {
            if (chartModelChangeHandlerKey in subscriber)
                subscriber[chartModelChangeHandlerKey](this, timestamp);
            else
