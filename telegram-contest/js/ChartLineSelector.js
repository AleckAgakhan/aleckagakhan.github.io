define(["require", "exports", "./ThemableCheckbox", "./ChartModel", "./ChartContextTemplateConsumer"], function (require, exports, ThemableCheckbox_1, ChartModel_1, ChartContextTemplateConsumer_1) {
    ...
    class ChartLineSelector {
        ...
        [ThemableCheckbox_1.boolValueChangeHandlerKey](value, lineKey) {
            const model = this._model;
            if (!model)
                return;
            model.setVisibility(lineKey, value);
        }
        [ChartModel_1.chartModelChangeHandlerKey](model) {
            let index = 0;
            const checkboxList = this.checkboxList;
    ...
    class ChartLineSelectorElement extends ChartContextTemplateConsumer_1.ChartContextTemplateConsumerElement {
