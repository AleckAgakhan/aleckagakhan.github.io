import { missingAttrMsg, missingTemplateProviderMsg, missionTemplateElementMsg } from "./common";
...
export class ThemableCheckbox extends HTMLElement {
    ...
    connectedCallback() {
        ...
        if (!labelElement)
            throw new Error(missionTemplateElementMsg(TagName, "label-id", labelId));
