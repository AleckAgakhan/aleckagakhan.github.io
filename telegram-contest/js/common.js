define(["require", "exports"], function (require, exports) {
    ...
    exports.missingAttrMsg = (tagName, attr) => `The required attribute <${tagName} ${attr}="..."> is missing or empty.`;
    exports.missingTemplateProviderMsg = (tagName) => `Unable to find tempalte provider: <${tagName}> can only be placed within shadow tree of a template provider element or its shadow descendants.`;
    exports.missionTemplateElementMsg = (tagName, attr, id) => `Unable to find the element specified by the reference <${tagName} ${attr}="${id}">`;
    exports.missingElementInsideTemplateMsg = (tagName, templateKey, elementId) => `<${tagName}> requires the element with the id '${elementId}' inside the template '${templateKey}'.`;
    exports.delay = (timemout = 0) => new Promise((resolve) => setTimeout(resolve, timemout));
    ...
    exports.Color = Color;
    exports.getMonthDayString = (date) => months[date.getMonth()] + ' ' + date.getDate().toString();
