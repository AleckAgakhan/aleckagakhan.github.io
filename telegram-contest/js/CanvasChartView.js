define(["require", "exports", "./ChartModel", "./ChartTheme", "./common", "./ChartContextTemplateConsumer"], function (require, exports, ChartModel_1, ChartTheme_1, common_1, ChartContextTemplateConsumer_1) {
    ...
    class CanvasChartView {
        ...
        [ChartModel_1.chartModelChangeHandlerKey](model, timestamp) {
            ...
            if (currRangeLength > 0.5) {
                ...
                while (true) {
                    ...
                    const text = common_1.getMonthDayString(date);
        ...
        renderAnimationFrame(timestamp) {
            ...
            if (animationState.lineInfoMap.size === 0)
                return;
            const color = new common_1.Color();
            ...
            if (isMaxAnimation && progressRatio < 1) {
                const labelColor = new common_1.Color(themeLabelColor);
        ...
        updatePointToolTip() {
            ...
            for (const line of this._model.currVisibleLines) {
                ...
                if (!pointInfoElement) {
                    ...
                    if (!lineNameElement)
                        throw new Error(common_1.missionTemplateElementMsg(exports.TagName, this.pointInfoTemplateKey, "LineName"));
                    ...
                    if (!pointValueElement)
                        throw new Error(common_1.missionTemplateElementMsg(exports.TagName, this.pointInfoTemplateKey, "PointValue"));
    ...
    class CanvasChartViewElement extends ChartContextTemplateConsumer_1.ChartContextTemplateConsumerElement {
