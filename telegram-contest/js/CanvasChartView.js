...
import { getCurrentTheme, addShadowRootContainer, removeShadowRootContainer } from "./ChartTheme";
import { Color, getMonthDayString, PIx2, missionTemplateElementMsg, missingElementInsideTemplateMsg } from "./common";
import { ChartContextTemplateConsumerElement } from "./ChartContextTemplateConsumer";
    ...
    updatePointToolTip() {
        ...
        for (const line of this._model.currVisibleLines) {
            ...
            if (!pointInfoElement) {
                ...
                if (!lineNameElement)
                    throw new Error(missionTemplateElementMsg(TagName, this.pointInfoTemplateKey, "LineName"));
                ...
                if (!pointValueElement)
                    throw new Error(missionTemplateElementMsg(TagName, this.pointInfoTemplateKey, "PointValue"));
