define(["require", "exports"], function (require, exports) {
    ...
    exports.getThemeList = () => themeMap.values();
    exports.themeChangeHandler = Symbol('ChartThemeChangeHandler');
    const subscribers = new Set();
    exports.themeSubscribe = (subscriber) => {
        subscribers.add(subscriber);
    };
    exports.themeUnsubscribe = (subscriber) => {
        subscribers.delete(subscriber);
    };
    const shadowRootContainerMap = new Map();
    exports.addShadowRootContainer = (element) => {
        ...
        const style = createThemeStyleElement(shadowRoot, exports.getCurrentTheme());
        shadowRootContainerMap.set(element, style);
    };
    exports.removeShadowRootContainer = (element) => {
